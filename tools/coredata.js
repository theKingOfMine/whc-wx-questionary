...
// [DSM-5/SLD/PRS/T]学龄儿童学习能力持续性发展特质 教育实践综合评估量表（教师问卷版）
export const SLD_PRS_T = [
  ...
  },
  {
    ...
    form: [
      ...
      {
        label: '手指的灵巧程度 （使用剪刀、扣纽 扣、书写、握球等）',
        component:'checkBox',
        type: 'string',
        selectList: [
          '1. 手指很笨拙；',
  ...
  },
  {
    ...
    form: [
      ...
      {
        label: '理解任务并进行处 理的能力（作业、 规定、大家所决定 的事等）',
        component:'checkBox',
        type: 'string',
        selectList: [
          '1. 给予指导也不能完成；',
